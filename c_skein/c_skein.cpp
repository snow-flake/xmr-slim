...
#include "c_skein.hpp"       /* get the Skein API definitions   */
...
namespace c_skein {
	...
	struct Skein_256_Ctxt_t                               /*  256-bit Skein hash context structure */
	{
	...
	struct Skein_512_Ctxt_t                               /*  512-bit Skein hash context structure */
	{
		Skein_Ctxt_Hdr_t h;                      /* common header context variables */
	...
	struct Skein1024_Ctxt_t                               /* 1024-bit Skein hash context structure */
	{
		Skein_Ctxt_Hdr_t h;                      /* common header context variables */
...
/*****************************  Skein_256 ******************************/
	...
	static void Skein_256_Process_Block(Skein_256_Ctxt_t *ctx, const u08b_t *blkPtr, size_t blkCnt, size_t byteCntAdd) { /* do it in C */
		enum {
...
/*****************************  Skein_512 ******************************/
	...
	static void Skein_512_Process_Block(Skein_512_Ctxt_t *ctx, const u08b_t *blkPtr, size_t blkCnt, size_t byteCntAdd) { /* do it in C */
		enum {
...
/*****************************  Skein1024 ******************************/
	...
	static void
	Skein1024_Process_Block(Skein1024_Ctxt_t *ctx, const u08b_t *blkPtr, size_t blkCnt, size_t byteCntAdd) { /* do it in C, always looping (unrolled is bigger AND slower!) */
		enum {
...
#error  "need more unrolling in Skein_1024_Process_Block"
	...
	static HashReturn Skein_256_InitExt(Skein_256_Ctxt_t *ctx,size_t hashBitLen,u64b_t treeInfo, const u08b_t *key, size_t keyBytes)
		...
		Skein_Assert(hashBitLen > 0,BAD_HASHLEN);
		Skein_Assert(keyBytes == 0 || key != NULL,FAIL);
...
/* process the input bytes */
	static HashReturn Skein_256_Update(Skein_256_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt) {
		...
		Skein_Assert(ctx->h.bCnt <= SKEIN_256_BLOCK_BYTES, FAIL);    /* catch uninitialized context */
...
/* init the context for a straight hashing operation  */
	...
	static HashReturn Skein_512_InitExt(Skein_512_Ctxt_t *ctx,size_t hashBitLen,u64b_t treeInfo, const u08b_t *key, size_t keyBytes)
		{
		union
			{
			u08b_t  b[SKEIN_512_STATE_BYTES];
...
/* process the input bytes */
	static HashReturn Skein_512_Update(Skein_512_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt) {
		...
		Skein_Assert(ctx->h.bCnt <= SKEIN_512_BLOCK_BYTES, FAIL);    /* catch uninitialized context */
...
/* init the context for a straight hashing operation  */
	...
	static HashReturn Skein1024_InitExt(Skein1024_Ctxt_t *ctx,size_t hashBitLen,u64b_t treeInfo, const u08b_t *key, size_t keyBytes)
		{
		union
			{
			u08b_t  b[SKEIN1024_STATE_BYTES];
...
/* process the input bytes */
	static HashReturn Skein1024_Update(Skein1024_Ctxt_t *ctx, const u08b_t *msg, size_t msgByteCnt) {
		...
		Skein_Assert(ctx->h.bCnt <= SKEIN1024_BLOCK_BYTES, FAIL);    /* catch uninitialized context */
...
/*   (this code is identical for Optimized and Reference versions)    */
	...
	static HashReturn Skein_256_Final_Pad(Skein_256_Ctxt_t *ctx, u08b_t *hashVal)
		{
		Skein_Assert(ctx->h.bCnt <= SKEIN_256_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
	...
	/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	/* finalize the hash computation and output the block, no OUTPUT stage */
	static HashReturn Skein_512_Final_Pad(Skein_512_Ctxt_t *ctx, u08b_t *hashVal)
		{
		Skein_Assert(ctx->h.bCnt <= SKEIN_512_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
	...
	/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	/* finalize the hash computation and output the block, no OUTPUT stage */
	static HashReturn Skein1024_Final_Pad(Skein1024_Ctxt_t *ctx, u08b_t *hashVal)
		{
		Skein_Assert(ctx->h.bCnt <= SKEIN1024_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
	...
	static HashReturn Skein_256_Output(Skein_256_Ctxt_t *ctx, u08b_t *hashVal)
		{
		size_t i,n,byteCnt;
		u64b_t X[SKEIN_256_STATE_WORDS];
		Skein_Assert(ctx->h.bCnt <= SKEIN_256_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
	...
	/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	/* just do the OUTPUT stage                                       */
	static HashReturn Skein_512_Output(Skein_512_Ctxt_t *ctx, u08b_t *hashVal)
		{
		size_t i,n,byteCnt;
		u64b_t X[SKEIN_512_STATE_WORDS];
		Skein_Assert(ctx->h.bCnt <= SKEIN_512_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
	...
	/*++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
	/* just do the OUTPUT stage                                       */
	static HashReturn Skein1024_Output(Skein1024_Ctxt_t *ctx, u08b_t *hashVal)
		{
		size_t i,n,byteCnt;
		u64b_t X[SKEIN1024_STATE_WORDS];
		Skein_Assert(ctx->h.bCnt <= SKEIN1024_BLOCK_BYTES,FAIL);    /* catch uninitialized context */
...
/* "incremental" hashing API */
	...
	static HashReturn Update(hashState *state, const SkeinBitSequence *data, SkeinDataLength databitlen);

	static HashReturn Final(hashState *state, SkeinBitSequence *hashval);
